...
public static class EnvironmentVariableConfiguration
{
    private static readonly IReadOnlyDictionary<string, string> mappings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["ARTIFACT_DIGEST_OSU"] = "Calculator:ArtifactDigests:osu",
        ["ARTIFACT_DIGEST_TAIKO"] = "Calculator:ArtifactDigests:taiko",
        ["ARTIFACT_DIGEST_FRUITS"] = "Calculator:ArtifactDigests:fruits",
        ["ARTIFACT_DIGEST_MANIA"] = "Calculator:ArtifactDigests:mania",
        ...
        ["DIFFICULTY_ARTIFACT_DIGEST_OSU"] = "Calculator:DifficultyArtifactDigests:osu",
        ["DIFFICULTY_ARTIFACT_DIGEST_TAIKO"] = "Calculator:DifficultyArtifactDigests:taiko",
        ["DIFFICULTY_ARTIFACT_DIGEST_FRUITS"] = "Calculator:DifficultyArtifactDigests:fruits",
        ["DIFFICULTY_ARTIFACT_DIGEST_MANIA"] = "Calculator:DifficultyArtifactDigests:mania",
